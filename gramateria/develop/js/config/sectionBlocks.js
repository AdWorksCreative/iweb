...
export default [
  ...
  },
  {
    ...
    content: `
    <section id="header-three" style="position:relative; padding-top:0">
   
    <img src="https://drive.google.com/uc?export=view&id=1RQsYnjx_dT2LX6ghsqIMapelIKgJDYMC" class="img-fluid" alt="Responsive image">
    <div class="center">
            <div class="d-flex flex-column align-items-center justify-content-center">
                
                <h5>INTRODUCTION</h5>
                <h1>ADD YOUR SLIDER HERE</h1>
                <div class="col-sm-6">
                <p class="my-4 text-center">Maecenas sed diam eget risus varius blandit sit amet non magna. Nullam quis risus eget urna mollis ornare vel eu leo. Integer posuere erat a ante venenatis dapibus posuere velit aliquet.</p>
                </div>
                <div class="hero-buttons mt-5">
                    <button class="btn btn-outline-success border-success text-white me-2">LEARN MORE</button>
                    <button class="btn btn-success">TRY IT NOW</button>
                </div>
            </div>
        </div>
    ...
    #header-three h1{font-size:60px;text-transform:uppercase;}
    #header-three h5{font-size:18px;font-weight:100;text-transform:uppercase;}
    #header-three p{font-size:14px;}
    #header-three .btn{width:180px;}
    @media(max-width:768px){
        #header-three .center{
...
},
{
    ...
    content: `
    <section id="header-four" style="position:relative; padding-top:0" >
   
    <img src="https://drive.google.com/uc?export=view&id=1aTLEvB_6wai6qlOUr7x9_-3NqoTOJsUH" class="img-fluid" alt="Responsive image">
    <div class="center">
            <div class="d-flex flex-column align-items-center justify-content-center">
                ...
                <div class="hero-buttons mt-5">
                    <button class="btn btn-outline-dark border-white text-white me-2">LEARN MORE</button>
                    <button class="btn btn-dark">TRY IT NOW</button>
                </div>
            </div>
        </div>
    ...
    #header-four h1{font-size:60px;text-transform:uppercase;}
    #header-four h5{font-size:18px;font-weight:100;text-transform:uppercase;}
    #header-four p{font-size:14px;}
    #header-four .btn{width:180px;}
    @media(max-width:768px){
        #header-four .center{
...
},
{
    ...
    content: `
    <section id="header-five" class="d-flex flex-column align-items-center justify-content-center bg-white pt-0">
                
        <h3 class="text-uppercase">ADD TITLE TEXT</h3>
        <h5 class="text-uppercase my-4">ADD PARAGRAPH TEXT</h5>
        <div class="col-sm-6">
        
        <p class="text-center">Fusce dapibus, tellus ac cursus commodo, tortor mauris condimentum nibh, ut fermentum massa justo sit amet risus. Cras justo odio, dapibus ac facilisis in, egestas eget quam. Vivamus sagittis lacus vel augue laoreet rutrum faucibus dolor auctor.</p>
        
        <p class="text-center my-4">Integer posuere erat a ante venenatis dapibus posuere velit aliquet. Vestibulum id ligula porta felis euismod semper.</p>
        </div>
    ...
    #header-five h3{font-size:36px;font-weight:600; margin-top:8%;}
    #header-five h5{font-size:16px;font-weight:600;}
    #header-five p{font-size:14px;}
...

{
    ...
    content: `
    <section id="title" class="bg-white pt-0">
                
        <p class="text-center py-3">Title goes here</p>
...

  {
    ...
    content: `<section id="blog-two" class="bg-white pt-0">
        
    <div class="container-fluid">
    <div class="row justify-content-center py-5">
      
    
    <div class="col px-0 m-3">
      
        <img src="https://drive.google.com/uc?export=view&id=1nYr--gKfS7qmDmqtcXbh5STLWYSwXozp" class="img-fluid" alt="Responsive image">
        <div class="text">
        <p class="title">Inspection</p>
        <p class="description">In general, our opinion is that repairing your device is more efficient and money-saving. For the money part.</p>
        
        </div>
    </div>
    <div class="col px-0 m-3">
      
        <img src="https://drive.google.com/uc?export=view&id=18LNOy3F-oMJBD_H0-NRHo9uZQ9PGs7CZ" class="img-fluid" alt="Responsive image">
        <div class="text">
        <p class="title">Inspection</p>
        <p class="description">In general, our opinion is that repairing your device is more efficient and money-saving. For the money part.</p>
    ...
    <div class="col px-0 m-3">
        ...
        <img src="https://drive.google.com/uc?export=view&id=1qYKyVY4xXahtFxvIQWqTxPV_ApaubzBl" class="img-fluid" alt="Responsive image">
        <div class="text">
        <p class="title">Inspection</p>
        <p class="description">In general, our opinion is that repairing your device is more efficient and money-saving. For the money part.</p>
    ...
    <div class="col px-0 m-3">
        ...
        <img src="https://drive.google.com/uc?export=view&id=1YXiD1-R2ZqEf2mFg3MRtriK9fpJR6z5G" class="img-fluid" alt="Responsive image">
        <div class="text">
        <p class="title">Inspection</p>
        <p class="description">In general, our opinion is that repairing your device is more efficient and money-saving. For the money part.</p>
  ...
  {
    id: 'section-blog-three',
    label: 'Blog Three',
    category: 'Sections',
    attributes: {
      class: 'fa fa-th-large'
    },
    content: `<section id="blog-three" class="bg-white pt-0">
  ...
  {
    id: 'section-gallery-two',
    label: 'Gallery Two',
    category: 'Sections',
    attributes: {
      class: 'fa fa-th'
    },
    content: `<section id="gallery-two" class="bg-white pt-0">
    ...
    <div class="col px-0">
        ...
        <img src="https://drive.google.com/uc?export=view&id=1EGjlUt7T-5XEJp6NfvIpsPN6HseX4Lo2" class="img-fluid" alt="Responsive image">
        
    </div>
    <div class="col px-0 ">
      
        <img src="https://drive.google.com/uc?export=view&id=1CGsweJfnIo8C1a651uj9JDYc7lOHxLY1" class="img-fluid" alt="Responsive image">
        
    </div>
    <div class="col px-0 ">
      
        <img src="https://drive.google.com/uc?export=view&id=1e-K5LAdL-W4vULFBcnVp-RVkwoJoUR3G" class="img-fluid" alt="Responsive image">
        
    </div>
    <div class="col px-0 ">
      
        <img src="https://drive.google.com/uc?export=view&id=1-7OuQNjs5v-1xf2KZoFU7sssmYCzI4mQ" class="img-fluid" alt="Responsive image">
    ...
    <div class="col px-0">
        ...
        <img src="https://drive.google.com/uc?export=view&id=1DPLKnG2FO5FHCkNdqhvt3ZIBqDXWrdOY" class="img-fluid" alt="Responsive image">
        
    </div>
    <div class="col px-0 ">
      
        <img src="https://drive.google.com/uc?export=view&id=1VB6vR1whV1C_NAC2ukQw_sa-w-GrcuGk" class="img-fluid" alt="Responsive image">
        
    </div>
    <div class="col px-0 ">
      
        <img src="https://drive.google.com/uc?export=view&id=12ZyemuKpeHJWkbIGRqKdaFYQWr4hpfmP" class="img-fluid" alt="Responsive image">
        
    </div>
    <div class="col px-0 ">
      
        <img src="https://drive.google.com/uc?export=view&id=1Dms-qZtApACrdNQAvbZDz-ds3H9CHI62" class="img-fluid" alt="Responsive image">
  ...
  },
  {
    ...
    content:`<section id="buttons" class="bg-white">
    <div class="container-fluid ">
      <div class="row justify-content-center py-3">
        
      <div class="col text-center">
        <div class="position">
            <img src="https://drive.google.com/uc?export=view&id=1IXlMAsO4J5emsqJhqIxH4M4Xc4038mou" class="img-fluid img-thumbnail" alt="Responsive image">
            <div class="center">
      ...
      <div class="col text-center">
      <div class="position">
      <img src="https://drive.google.com/uc?export=view&id=1xUQfv6jhnzQcxWtsJhaTwBQ8V9oeczjs" class="img-fluid img-thumbnail" alt="Responsive image">
      <div class="center">
      <button class="button">Button</button>
      </div>
      </div>
      ...
      <div class="col text-center">
      <div class="position">
      <img src="https://drive.google.com/uc?export=view&id=1E5G7J2LHmA3YoYpIXxiewUXc6u07_nES" class="img-fluid img-thumbnail" alt="Responsive image">
      <div class="center">
      <button class="button">Button</button>
      </div></div>
      </div>
  ...
  {
    id: 'section-contact-two',
    label: 'Contact Two',
    category: 'Sections',
    attributes: {
      class: 'fa fa-envelope'
    },
    content: `<section id="contact-two" class="pt-0">
    ...
    <div class="col px-0">
        ...
        <p class="description">Add paragraph text here</p>
        <p class="title mt-2">ADD TITLE TEXT HERE</p>
        
    </div>
    <div class="col px-0">
    
        <button class="btn mt-4">CONTACT US</button>
 ...
 .parallax {
  ...
  {
    id:'section-parallax-two',
    label:'Parallax Two',
    category:'Sections',
    attributes:{
    class:"fa fa-copy"
    },
    content:`<section id="parallax-two" class="bg-white pt-0">
    <div class="container">
    <div class="row">
        
        <div class="col-md-6 my-5">
            <div class="px-5">
                <h3 class="my-5">ADD TITLE TEXT</h3>
               
                <h5 class="text-uppercase my-4">ADD PARAGRAPH TEXT</h5>
                
                <p class="my-4">Fusce dapibus, tellus ac cursus commodo, tortor mauris condimentum nibh, ut fermentum massa justo sit amet risus. Cras justo odio, dapibus ac facilisis in, egestas eget quam. Vivamus sagittis lacus vel augue laoreet rutrum faucibus dolor auctor.</p>
              
                <p>Integer posuere erat a ante venenatis dapibus posuere velit aliquet. Vestibulum id ligula porta felis euismod semper.</p>
                
                <button class="btn btn-dark mt-4">FIND OUT MORE</button>
                
            </div>
        </div>
        <div class="col-md-6 my-5 px-0">
        
        <img src="https://drive.google.com/uc?export=view&id=1Kbvb05hXuIurdulfO94DiSMrJnqIk_GM" class="img" alt="Responsive image">
...
#parallax-two h3{font-size:36px;font-weight:600; text-transform: uppercase;}
#parallax-two h5{font-size:16px;font-weight:600;}
#parallax-two p{font-size:14px;}
#parallax-two .img{
    height:auto;
    min-height:540px;
    width:100%;
}
#parallax-two .btn{width:180px;}

</style>`
},
{
    id:'section-parallax-three',
    label:'Parallax Three',
    category:'Sections',
    attributes:{
    class:"fa fa-copy"
    },
    content:`<section id="parallax-three"  style="background-color:#B4D6DC;">
    <div class="container">
    <div class="row">
        <div class="col-md-6 my-5 px-0">
            
        <img src="https://drive.google.com/uc?export=view&id=1PqZwZUsWOse30U9VKrEoPxWBEcNK-iAt" class="img" alt="Responsive image">
...
<style>
    ...
    #parallax-three h3{font-size:36px;font-weight:600; text-transform: uppercase;}
    #parallax-three h5{font-size:16px;font-weight:600;}
    #parallax-three p{font-size:14px;}
    #parallax-three .img{
        height:auto;
        min-height:540px;
        width:100%;
    }
    #parallax-three .btn{width:180px;}
